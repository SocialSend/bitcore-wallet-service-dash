...
function Insight(opts) {
  ...
  this.apiPrefix = _.isUndefined(opts.apiPrefix)? '/insight-api-socialsend' : opts.apiPrefix;
...
Insight.prototype.translateQueryAddresses = function(addresses) {
  ...
  // module was created for insight-api-socialsend
...
/**
 * Broadcast a instantsend transaction to the SocialSend network
 */
Insight.prototype.broadcastix = function(rawTx, cb) {
    var args = {
        method: 'POST',
        path: this.apiPrefix + '/tx/sendix',
        json: {
            rawtx: rawTx
        },
    };
